...
public class Game {
    ...
    // private Room currentRoom;  // 私人房间currentRoom;
    // private int intCurrentRoom; // 房间个数
    ...
    public Game() throws Exception {
        parser = new Parser();
        player = new Player(); // Create player // 创建球员
        ...
        roomsXML.setFilename("/Users/huangjiabao/GitHub/SourceCode/Java_Coder/Student_Coder/liujiahui/World_ofZu/src/rooms.xml");
