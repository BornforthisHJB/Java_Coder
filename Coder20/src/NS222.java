        ...
        switch (digital_system) {
            case ("bin"):
                if (target.equals("dec")) {
                    int bin_to_dec = BinToDec(Opr_num);
                    System.out.println(bin_to_dec);
                }
                break;
            case ("oct"):
                String dec_to_binary1 = DecToOct(Integer.parseInt(Opr_num));
                System.out.print(dec_to_binary1);
            case ("hex"):
                String dec_to_binary2 = DecToHex(Integer.parseInt(Opr_num));
                System.out.print(dec_to_binary2);
        }
    }
